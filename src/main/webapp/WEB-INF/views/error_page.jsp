...
<div class="welcome-page">
    <div class="welcome-container">
        <div class="welcome-image" style="margin-bottom: 50px">
            <svg width="300" height="200" viewBox="0 0 196 45" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="title">
            Não estás onde de<span style="color:#1F7EB2; font-weight: 800">VIAS</span>!
        </div>
