                ...
                <div class="carousel-item">
                    <div class="contact-box">
                        <form action="/send_message" method="POST">
                            <div class="mb-3">
                                <label class="form-label text-start" for="name">Nome</label>
                                <input class="form-box-contact formtext-contact" type="text" id="name1" name="name"
                                       placeholder="Insira o seu nome" required>
                            </div>
                            <div class="mb-3">
                                <label class="form-label text-start" for="number">Número de Telemóvel</label>
                                <input class="form-box-contact formtext-contact" type="number" id="number" name="number"
                                       placeholder="Insira o seu número de telemóvel" required>
                            </div>
                            <div class="mb-3">
                                <label class="form-label text-start" for="text_id">Mensagem</label>
                                <textarea class="form-box-contact formtext-contact form-box-message" id="text_id1"
                                          name="text" max_length="500" placeholder="Insira a sua mensagem"
                                          required></textarea>
                            </div>
                            <div class="d-grid">
