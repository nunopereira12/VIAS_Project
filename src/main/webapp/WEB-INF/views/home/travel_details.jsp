    ...
    <div class="home-content" style="margin: 170px 0 0 0;">
        ...
        <div class="suggestions-box">
            ...
            <div class="card" id="suggestions-small-card" style="margin:40px 10px 10px 10px;">
                <div>
                    <h2 style="font-size: 1.2rem; font-weight: 600"><span><svg style="margin-right: 10px" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    ...
                    </g></svg>${leg.getStart_address()}</span></h2>
                    <h2 style="font-size: 1.2rem; font-weight: 600"><span><svg style="margin-right: 10px; margin-left: 5px" xmlns="http://www.w3.org/2000/svg" width="19" height="23"><path d="M2 15h9v3h8V5h-8V2H2V0H0v23h2zM8 4v3h3v3h3V7h3v3h-3v3h3v3h-3v-3h-3v-3H8v3H5v-3H2V7h3V4z"/><path d="M5 7h3v3H5z"/></svg>${leg.getEnd_address()}</span></h2>
