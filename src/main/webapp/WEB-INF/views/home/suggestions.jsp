...
<div class="home-container">
    ...
    <div class="suggestions-content">
        ...
        <div class="button-box">
            ...
            <svg style="margin:auto 7px auto" xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 40 40" fill="none">
                ...
                <input class="input-field" type="text" name="origem" id="origem1" value="${legs.get(0).getStart_address()}"></span></div>
                <div class="input-box">
                <svg style="margin:auto 7px auto" xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 40 40" fill="none">
                ...
                </svg><span style="margin: auto auto auto 0 "><input class="input-field" type="text" name="destino" id="destino1" value="${legs.get(0).getEnd_address()}"></span></div>
            <button></button>
    ...
    <script>
        ...
        const origin = document.getElementById("origem1");
        const destination = document.getElementById("destino1");
        const form = document.getElementById("form");

        origin.addEventListener("keypress", checkEnter);
        destination.addEventListener("keypress", checkEnter);

        // Function to check if "Enter" key was pressed and submit the form
        function checkEnter(event) {
            if (event.key === "Enter" && destination.value.trim() !== "" && origin.value.trim() !== "") {
