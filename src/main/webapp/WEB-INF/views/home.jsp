...
<nav class="navbar bg-body-tertiary fixed-top " style="padding: 0">
    <div class="container-fluid">
        <button class="navbar-toggler arrowbutton menubutton" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasNavbar" aria-controls="offcanvasNavbar" aria-label="Toggle navigation" style="margin: 70px 0 0 5px">
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel" >
            <button class="btn-close arrowbutton menubutton" data-bs-dismiss="offcanvas" aria-label="Close" style="margin: 15px 0 0 15px"></button>
            <div class="offcanvas-header" style="text-align: center; justify-content: center; border-bottom: 2px solid #D9D9D9">
                <c:choose>
                    <c:when test="${user.getRole() eq 'USER' }">
                    <a href="http://localhost:8080/profile"><button class="nav-perfil-button">
                        <img src="images/map1.png" width="80px" heigth="80px" alt="profile picture" style="border: #1E1E1E; border-radius: 80px">
                    <span><h5 style="margin-top:10px">${user.getFirstName()} ${user.getLastName()}</h5></span></button></a>
                    </c:when>
...
<div class="home-container">
    ...
    <div class="home-content">
        ...
        </svg><span style="margin-bottom:10px">Bilhete Digital</span></button></a>
    </div>
...
<c:when test="${user.getRole() eq 'PICA'}">
    <div class="search-box pica-search-box">
        <div class="home-title">
            <h3>Para onde vai?</h3>
        </div>
        <div>
            <form>
                <div class="search-bar pica-search-box" style="border-bottom: 2px solid #D9D9D9 ">
                    <input style="border: none" type="text" name="origem" id="origem2" placeholder="A sua origem" required>
                    <button class="form-button"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 40 41" fill="none">
                        <mask id="mask0_15_302" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="40" height="41">
                            <path d="M0 0.5H40V40.5H0V0.5Z" fill="#FFFFFF"/>
                        </mask>
                ...
                <div class="search-bar" >
                    <input style="border: none" type="text" name="destino" id="destino2" placeholder="O seu destino" required>
                    <button class="form-button"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="none">
                        <mask id="mask0_15_307" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0">
                            <path d="M0 0.5H30V30.5H0V0.5Z" fill="#FFFFFF"/>
                        </mask>
    ...
    <div class="date-hour-box pica-search-box">
        <div class="btn-group" role="group" aria-label="Basic example">
            <button type="button" class="btn btn-secondary" >
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    <mask id="mask0_189_1662" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
