        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel" >
            ...
            <div class="offcanvas-header" style="text-align: center; justify-content: center; border-bottom: 2px solid #D9D9D9">
                ...
                <a href="http://localhost:8080/login"><button class="nav-perfil-button">
                    <img src="images/account_circle.png" width="80px" heigth="80px" alt="profile picture" style="border: #1E1E1E; border-radius: 80px">
                    <span> Entrar na sua conta </span></button></a>
                </c:when>
                </c:choose>
            </div>
