        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel" >
            ...
            <div class="offcanvas-header" style="text-align: center; justify-content: center; border-bottom: 2px solid #D9D9D9">
                <c:choose>
                    ...
                    <a href="http://localhost:8080/loprofilegin"><button class="nav-perfil-button">
            ...
            <div class="offcanvas-body">
                <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                    ...
                    <c:choose>
                    <c:when test="${user.getRole() eq 'PICA' or 'null'}">
                        <li class="nav-item nav-option-big">
                            <a class="nav-link" href="">Horários</a>
                        </li>
                        <li class="nav-item nav-option-big">
...
<c:when test="${user.getRole() eq 'PICA'}">
    ...
    <a href="http://localhost:8080/id_pica"> <button class="wallet-button" style="margin-top:70px"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
